...
export declare const CoreSharedOptionsSchema: z.ZodEffects<z.ZodObject<{
    ...
    handleUncaughtError: z.ZodOptional<z.ZodType<(error: Error) => void, z.ZodTypeDef, (error: Error) => void>>;
    ...
    defaultProjectTmpPath: z.ZodOptional<z.ZodString>;
...
export declare function getEmailPathsToClean(defaultProjectTmpPath: string | undefined, tmpPath: string): {
    sessionDir: string;
    parentDir: string;
} | undefined;
...
export declare function getGlobalServices({ sharedOptions, allWorkerRoutes, fallbackWorkerName, loopbackPort, tmpPath, log, proxyBindings, durableObjectClassNames, workflowOptions, allWorkerOpts, }: GlobalServicesOptions): Service_2[];
...
export declare interface PluginBase<Options extends z.ZodType, SharedOptions extends z.ZodType | undefined> {
    ...
    getServices(options: PluginServicesOptions<Options, SharedOptions>): Awaitable<Service_2[] | ServicesExtensions | void>;
